<template>
  ...
  <div class="flex flex-col justify-center min-h-[90%] overflow-y-hidden">
    <motion.div
  ...
  <div class="flex flex-col text-end bottom-0 absolute right-0 overflow-hidden px-5">
